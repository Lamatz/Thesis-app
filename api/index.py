...
# import pandas as pd # Commented out
# from datetime import datetime, timedelta # Commented out
...
# =================================================================
# COMMENT OUT EVERY OTHER ROUTE AND EVERY OTHER FUNCTION BELOW THIS
# =================================================================


# @app.route("/api/some_endpoint") # Example
# def some_endpoint(): # Example
#     # All the code here # Example
#     return "foo" # Example

# model = load_model('my_model.pkl') # Example of global code to comment out
